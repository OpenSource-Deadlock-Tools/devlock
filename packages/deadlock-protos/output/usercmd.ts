...
class CInButtonStatePB$Type extends MessageType<CInButtonStatePB> {
	...
	create(value?: PartialMessage<CInButtonStatePB>): CInButtonStatePB {
		...
		if (value !== undefined) reflectionMergePartial<CInButtonStatePB>(this, message, value);
		return message;
	}
	internalBinaryRead(
	...
	internalBinaryWrite(message: CInButtonStatePB, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.buttonstate1 !== undefined) writer.tag(1, WireType.Varint).uint64(message.buttonstate1);
		/* optional uint64 buttonstate2 = 2; */
		if (message.buttonstate2 !== undefined) writer.tag(2, WireType.Varint).uint64(message.buttonstate2);
		/* optional uint64 buttonstate3 = 3; */
		if (message.buttonstate3 !== undefined) writer.tag(3, WireType.Varint).uint64(message.buttonstate3);
...
class CSubtickMoveStep$Type extends MessageType<CSubtickMoveStep> {
	constructor() {
		super("CSubtickMoveStep", [
			...
			{
				no: 4,
				name: "analog_forward_delta",
				kind: "scalar",
				localName: "analog_forward_delta",
				opt: true,
				T: 2 /*ScalarType.FLOAT*/,
			},
			{
				no: 5,
				name: "analog_left_delta",
				kind: "scalar",
				localName: "analog_left_delta",
				opt: true,
				T: 2 /*ScalarType.FLOAT*/,
			},
		]);
	...
	create(value?: PartialMessage<CSubtickMoveStep>): CSubtickMoveStep {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<CSubtickMoveStep>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
	...
	internalBinaryWrite(message: CSubtickMoveStep, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.button !== undefined) writer.tag(1, WireType.Varint).uint64(message.button);
		/* optional bool pressed = 2; */
		if (message.pressed !== undefined) writer.tag(2, WireType.Varint).bool(message.pressed);
		/* optional float when = 3; */
		if (message.when !== undefined) writer.tag(3, WireType.Bit32).float(message.when);
		/* optional float analog_forward_delta = 4; */
		if (message.analog_forward_delta !== undefined) writer.tag(4, WireType.Bit32).float(message.analog_forward_delta);
		/* optional float analog_left_delta = 5; */
		if (message.analog_left_delta !== undefined) writer.tag(5, WireType.Bit32).float(message.analog_left_delta);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class CBaseUserCmdPB$Type extends MessageType<CBaseUserCmdPB> {
	constructor() {
		super("CBaseUserCmdPB", [
			{
				no: 1,
				name: "legacy_command_number",
				kind: "scalar",
				localName: "legacy_command_number",
				opt: true,
			...
			{
				no: 14,
				name: "pawn_entity_handle",
				kind: "scalar",
				localName: "pawn_entity_handle",
				opt: true,
			...
			{
				no: 20,
				name: "consumed_server_angle_changes",
				kind: "scalar",
				localName: "consumed_server_angle_changes",
				opt: true,
				T: 13 /*ScalarType.UINT32*/,
			},
			{
	...
	create(value?: PartialMessage<CBaseUserCmdPB>): CBaseUserCmdPB {
		...
		if (value !== undefined) reflectionMergePartial<CBaseUserCmdPB>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* optional CInButtonStatePB buttons_pb */ 3:
					message.buttons_pb = CInButtonStatePB.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.buttons_pb,
				...
				case /* repeated CSubtickMoveStep subtick_moves */ 18:
					message.subtick_moves.push(CSubtickMoveStep.internalBinaryRead(reader, reader.uint32(), options));
					break;
	...
	internalBinaryWrite(message: CBaseUserCmdPB, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.legacy_command_number !== undefined)
			writer.tag(1, WireType.Varint).int32(message.legacy_command_number);
		/* optional int32 client_tick = 2; */
		if (message.client_tick !== undefined) writer.tag(2, WireType.Varint).int32(message.client_tick);
		/* optional CInButtonStatePB buttons_pb = 3; */
		if (message.buttons_pb)
			CInButtonStatePB.internalBinaryWrite(
				message.buttons_pb,
		...
		if (message.forwardmove !== undefined) writer.tag(5, WireType.Bit32).float(message.forwardmove);
		/* optional float leftmove = 6; */
		if (message.leftmove !== undefined) writer.tag(6, WireType.Bit32).float(message.leftmove);
		/* optional float upmove = 7; */
		if (message.upmove !== undefined) writer.tag(7, WireType.Bit32).float(message.upmove);
		/* optional int32 impulse = 8; */
		if (message.impulse !== undefined) writer.tag(8, WireType.Varint).int32(message.impulse);
		/* optional int32 weaponselect = 9; */
		if (message.weaponselect !== undefined) writer.tag(9, WireType.Varint).int32(message.weaponselect);
		/* optional int32 random_seed = 10; */
		if (message.random_seed !== undefined) writer.tag(10, WireType.Varint).int32(message.random_seed);
		/* optional int32 mousedx = 11; */
		if (message.mousedx !== undefined) writer.tag(11, WireType.Varint).int32(message.mousedx);
		/* optional int32 mousedy = 12; */
		if (message.mousedy !== undefined) writer.tag(12, WireType.Varint).int32(message.mousedy);
		/* optional uint32 pawn_entity_handle = 14; */
		if (message.pawn_entity_handle !== undefined) writer.tag(14, WireType.Varint).uint32(message.pawn_entity_handle);
		/* repeated CSubtickMoveStep subtick_moves = 18; */
		for (let i = 0; i < message.subtick_moves.length; i++)
			CSubtickMoveStep.internalBinaryWrite(
				message.subtick_moves[i],
				writer.tag(18, WireType.LengthDelimited).fork(),
				options,
			).join();
		/* optional bytes move_crc = 19; */
		if (message.move_crc !== undefined) writer.tag(19, WireType.LengthDelimited).bytes(message.move_crc);
		/* optional uint32 consumed_server_angle_changes = 20; */
		if (message.consumed_server_angle_changes !== undefined)
			writer.tag(20, WireType.Varint).uint32(message.consumed_server_angle_changes);
		/* optional int32 cmd_flags = 21; */
		if (message.cmd_flags !== undefined) writer.tag(21, WireType.Varint).int32(message.cmd_flags);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class CUserCmdBasePB$Type extends MessageType<CUserCmdBasePB> {
	constructor() {
		super("CUserCmdBasePB", [{ no: 1, name: "base", kind: "message", T: () => CBaseUserCmdPB }]);
	}
	create(value?: PartialMessage<CUserCmdBasePB>): CUserCmdBasePB {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<CUserCmdBasePB>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
