...
use lapin::{BasicProperties, Channel, Connection, ConnectionProperties, Error};
use log::info;
...
pub async fn add_to_queue(body: &str) -> Result<(), Error> {
...
async fn get_rmq_channel() -> Result<&'static Channel, Error> {
